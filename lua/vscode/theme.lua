...
theme.set_highlights = function(opts)
    ...
    hl(0, 'Normal', { fg = "#ffffff", bg = '#181818' })
    hl(0, "NormalNC", {fg = "#ffffff", bg = "#181818"})
    ...
    hl(0, "EndOfBuffer", {fg = '#6e7681', bg = 'none'})
    ...
    hl(0, "SignColumn", { fg = 'none', bg = "#181818" })
    hl(0, 'IncSearch', { fg = c.vscNone, bg = c.vscSearchCurrent })
    hl(0, 'LineNr', { fg = c.vscLineNumber, bg = '#181818' })
    ...
    hl(0, "MsgArea", {fg = "#ffffff", bg = "#181818"})
    hl(0, "ModeMsg", {fg = "#ffffff", bg = "#181818"})
    hl(0, 'NonText', { fg = (isDark and c.vscLineNumber or c.vscTabOther), bg = c.vscNone })
    hl(0, "FloatBorder", {fg = '#6e7681', bg = 'none'})
    ...
    hl(0, "StatusLine", {fg = "#ffffff", bg="#1e1e1e"})
    hl(0, "StatusLineNC", {fg = "#ffffff", bg="#1e1e1e"})
    ...
    hl(0, 'Comment', { fg = c.vscGitIgnored, bg = 'NONE', italic = opts.italic_comments })
    ...
    hl(0, 'NormalFloat', {fg = "#ffffff", bg = "#181818"})
    ...
    hl(0, '@lsp.type.property', {fg = c.vscBlueGreen, bg = 'NONE' })
    ...
    hl(0, "NvimTreeNormal", { fg = '#a9a9a9', bg = 'NONE' })
    hl(0, "NvimTreeWinSeparator", { fg = c.vscSplitDark, bg = 'none' })
    hl(0, 'NvimTreeCursorLine', { fg = 'NONE', bg = c.vscSelection })
    hl(0, 'NvimTreeVertSplit', { fg = c.vscGitIgnored, bg = c.vscBack })
    hl(0, 'NvimTreeEndOfBuffer', { fg = '#6e7681', bg = 'none' })
    hl(0, 'NvimTreeOpenedFolderName', { fg = '#f1f1f1', bg = 'NONE', bold = false })
    hl(0, "NvimTreeOpenedFile", { fg = '#f1f1f1', bg = 'NONE', bold = false })
    ...
    hl(0, 'LspSignatureActiveParameter', { bold = true })
    ...
    if isDark then
        ...
        hl(0, "NvimTreeIndentMarker", {fg ='#8c8a8a', bg = 'none' })
