...
theme.set_highlights = function(opts)
    ...
    hl(0, "NvimTreeNormal",{fg = '#a9a9a9', bg = '#181818'})
    hl(0, "NvimTreeWinSeparator",{fg = '#a9a9a9', bg = 'none'})
    ...
    hl(0, 'NvimTreeOpenedFolderName', { fg = '#f1f1f1', bg = '#181818', bold = false })
    hl(0, "NvimTreeOpenedFile", { fg = "#f1f1f1", bg = "#181818", bold = true })
